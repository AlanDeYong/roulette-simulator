/**
 * ROULETTE STRATEGY: Smoke Show Strategy (V3 - Columns 2 & 3)
 * 
 * Source:
 ...
 * - The strategy places 6 non-overlapping Corner bets covering 24 numbers total (all of Columns 2 & 3).
 * - Corner anchors (top-left numbers): [2, 8, 14, 20, 26, 32]
 *   - Corner 2:  [2, 3, 5, 6]
 *   - Corner 8:  [8, 9, 11, 12]
...
function bet(spinHistory, bankroll, config, state, utils) {
  ...
  const initialCorners = [2, 8, 14, 20, 26, 32];

  // FORCE STATE RESET: Bumping version to 3 so the simulator drops the old array and uses the new one.
