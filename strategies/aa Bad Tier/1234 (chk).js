 ...
 * 
 * The Logic: Places bets on 3 to 4 double streets ('line' bets) to cover up to 24 numbers. 
 ...
 * - Step 2 (Loss 2): 5 base units on 4 double streets.
 * - Any win, or a loss at Step 2, resets the sequence back to Step 0.
 * 
...
function bet(spinHistory, bankroll, config, state, utils) {
    ...
    const progressionSteps = [
        ...
        { lines: [1, 7, 13, 19], multiplier: 5 }      // Loss 2
    ];
