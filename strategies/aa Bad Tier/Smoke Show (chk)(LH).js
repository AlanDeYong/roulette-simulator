/**
 * ROULETTE STRATEGY: Smoke Show Strategy (V2)
 * 
 * Source:
 ...
 * - The strategy places 6 non-overlapping Corner bets covering 24 numbers total (all of Columns 1 & 2).
 * - Corner anchors (top-left numbers): [1, 7, 13, 19, 25, 31]
...
function bet(spinHistory, bankroll, config, state, utils) {
  ...
  // FORCE STATE RESET: Hot-reloading preserves the `state` object across code updates. 
  // The version flag ensures the simulator drops the old overlapping array and uses the new one.
